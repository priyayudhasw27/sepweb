                ...
                <div class="header-top-area">
                    <div class="fixed-header-top">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="breadcome-list map-mg-t-40-gl shadow-reset">
                                            <h3 class="header-navigator">Administrator / File yang sudah di cetak</h3>
                                            <div class="row">
                        ...
                        <div class="right_col" role="main">
                            ...
                            <!-- Auto refresh Tabel Sudah Cetak -->
                            <!-- ===================================================================================== -->
                            <script type="text/javascript">
                                $(document).ready(function(){
                                    var auto_refresh=setInterval(function(){
                                        $('#tabel').load('sudahCetak/tabel').fadeIn("slow");
                                    },500);
                                });
                            </script>
                                                ...
                                                <tbody>
                                                    <?php foreach($hasil as $row){ ?>
                                                        <tr class="even pointer">
                                                            ...
                                                            <td>Harga Total</td>
                                                            <td><?php echo '<a href="sudahCetak/detail/'.$this->id.'">detail</a>'?></td>
                                                        </tr>  
                                                    <?php }; ?>
                                                </tbody>
                                            </table>
