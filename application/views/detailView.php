...
<div class="row">
    <div class="col-lg-3 center-block" style="float:none"><button class="btn btn-danger" onclick="window.location.href='../../belumCetak'">Kembali</button>
        <button class="btn btn-success" onclick="window.open('../lihatFile/<?php echo $this->id_berkas?>', '_blank'); window.location.href='../harga/<?php echo $this->id_transaksi?>'">Lihat File</button>
        </div>
